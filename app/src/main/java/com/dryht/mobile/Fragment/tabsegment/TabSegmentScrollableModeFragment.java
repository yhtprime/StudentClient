...
package com.dryht.mobile.Fragment.tabsegment;
...
import com.dryht.mobile.Fragment.BaseFragment;
...
//        mTabSegment1 = findViewById(R.id.tabSegment1);
//        mTabSegment1.setVisibility(View.GONE);
        mTabSegment = findViewById(R.id.tabSegment);
        mContentViewPager = findViewById(R.id.contentNewViewPager);
